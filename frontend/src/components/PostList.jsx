...
import { FiThumbsUp, FiMessageCircle, FiShare2, FiMoreHorizontal, FiFlag } from 'react-icons/fi';

const PostList = ({ posts, onLike, onReport, activeTimeline }) => {
              ...
              {activeMenu === post._id && (
                <div className="dropdown-menu">
                  <button
                    ...
                    onClick={() => {
                      onReport(post._id, 'post', post.author || post.userDisplayName);
                      setActiveMenu(null);
                    }}
                  >
